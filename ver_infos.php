...
<header>
    ...
    echo "</tr>";
            ...
            $consulta = "SELECT `nome`, `telefone`, `cargo`, `email` FROM funcionarios ORDER BY `id` ASC";
            ...
            echo "</tr>";
                    ...
                    echo "</tr>";
                            ...
                            $consulta = "SELECT `nome_prod`, `preco`, `fabricante`, `descricao`, `quantidade` FROM produtos ORDER BY `id` ASC";
                            $resultado = $conexao->query($consulta);
                            if ($resultado->num_rows > 0) {
                                while ($row = $resultado->fetch_assoc()) {
                                    echo "<tr>";
